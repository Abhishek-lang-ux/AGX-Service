...
import { apiRequest, normalizeAssetUrl, updateStoredUser } from "../lib/api.js";
...
function EditProfile() {
  ...
  const handleRemoveSelectedPhoto = () => {
     ...
     */
    setPhotoPreview(normalizeAssetUrl(profile?.avatarPath || ""));
  ...
  const handleSave = async (event) => {
    ...
    try {
      ...
      updateStoredUser({
        ...
        firstName: freshProfile.firstName,
        lastName: freshProfile.lastName,
        profileImage: normalizeAssetUrl(freshProfile.avatarPath || ""),
        avatarPath: normalizeAssetUrl(freshProfile.avatarPath || ""),
      });
       ...
       */
      setPhotoPreview(
        normalizeAssetUrl(freshProfile.avatarPath || ""),
      );
